                ...
                <div class="grid grid-cols-2 gap-4 mt-6">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4">
                        <form action="{{ route('calculator') }}" method="POST">
                            @csrf
                            <div class="flex items-center justify-center gap-2">
                                <input type="text" name="expression" class="p-6 w-[calc(100%+8rem)] h-12 rounded-lg bg-[#FF2D20] text-black text-center focus:outline-none"
                                value="{{ $expression ?? old('expression') }}"
                                placeholder="0" />
                            </div>
                        ...
                        <div class="flex items-center justify-center gap-4">
                            <input type="text" class="p-6 w-[calc(100%+8rem)] h-12 rounded-lg bg-[#FF2D20] dark:text-white text-center" placeholder="0" disabled value="{{ $result ?? '0' }}" />
                        </div>
                    </div>
                </div>
            </div>
